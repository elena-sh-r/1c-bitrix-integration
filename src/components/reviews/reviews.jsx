        ...
        <div className={`${reviewsStyles['reviews__overflow']}`}>
          <div className={`swiper-container reviews__slider']}`}>
            <div className={`swiper-wrapper`}>
              {data?.reviews?.map((review, idx) => <div key={idx} className={`swiper-slide`}>
                  <div className={`${reviewsStyles['reviews-item']}`}>
                    <div className={`${reviewsStyles['reviews-item__date']}`} dangerouslySetInnerHTML={{__html: review.date}}></div>
